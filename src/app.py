...
activities = {
    ...
    "Soccer Club": {
        "description": "Recreational and competitive soccer, skill development",
...
def unregister_participant(activity_name: str, email: str):
    """Unregister a student from an activity by email (passed as query param)

    Example: DELETE /activities/Chess%20Club/participants?email=student@mergington.edu
    """
    # Validate activity exists
    if activity_name not in activities:
        raise HTTPException(status_code=404, detail="Activity not found")
